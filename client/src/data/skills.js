// Each skill now carries a CDN logo URL (from devicon / simpleicons / official sources)
// for rendering real technology logos in the About section.
...
export const skillGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "DBMS",                   logo: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/mysql/mysql-original.svg" },
      ...
      { name: "Basic ML / scikit-learn", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/scikitlearn/scikitlearn-original.svg" },
    ],
  },
  {
    label: "Web / MERN",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Google Earth Engine",  logo: "https://earthengine.google.com/static/images/earth-engine-logo.png" },
    ],
  },
];
